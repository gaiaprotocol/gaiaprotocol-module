...
export default class GaiaNameSelectorModal extends StructuredModal {
  private selectedGaiaName: string | undefined;
  private useAsNameButton: Button;
  ...
  constructor() {
    ...
    this
      .appendToHeader(
        el("h1", "Choose Gaia Name"),
      )
      .appendToMain(
        el("p", "Select a Gaia Name to represent your identity"),
        new UserGaiaNameList(),
      )
      .appendToFooter(
        new Button(".cancel", {
          title: "Cancel",
