...
import { WalletLoginManager, WalletLoginPopup, } from "@common-module/wallet-login";
...
export default class UserAvatarButton extends DomNode {
    constructor() {
        ...
        this.render();
        this.subscribe(WalletLoginManager, "loginStatusChanged", () => this.render());
    }
    render() {
        this.empty().append(WalletLoginManager.isLoggedIn
            ? new Button({
...
//# sourceMappingURL=UserAvatarButton.js.map