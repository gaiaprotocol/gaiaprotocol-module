...
export interface MaterialTradeInterface extends Interface {
    getFunction(nameOrSignature: "buy" | "createMaterial" | "getBuyPrice" | "getBuyPriceAfterFee" | "getPrice" | "getSellPrice" | "getSellPriceAfterFee" | "initialize" | "materialOwnerFeePercent" | "owner" | "protocolFeeDestination" | "protocolFeePercent" | "renounceOwnership" | "sell" | "setMaterialOwnerFeePercent" | "setProtocolFeeDestination" | "setProtocolFeePercent" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [BigNumberish, AddressLike, BigNumberish, BigNumberish]): string;
