...
export default class TradeMaterialTabContent extends DomNode {
    ...
    constructor(address, tradeType) {
        ...
        this.append(el("section.amount", el("header", el("h3", "Amount"), el(".current-balance", el("span.label", "Your Balance"), this.balanceDisplay = el("span.balance", new AppCompConfig.LoadingSpinner()), new Button({
