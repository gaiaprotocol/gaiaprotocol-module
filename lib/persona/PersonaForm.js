...
import { AppCompConfig, Button, ButtonType, Input, InvisibleFileInput, } from "@common-module/app-components";
...
export default class PersonaForm extends DomNode {
    ...
    constructor(data) {
        super(".persona-form");
        this.data = data;
        this.append(this.avatarContainer = el(".avatar-container", this.avatar = new PersonaAvatar(PersonaUtils.convertPersonaToSocialUser(data), 120), new Button(".edit", {
    ...
    async uploadProfileImage(file) {
        const loadingSpinner = new AppCompConfig.LoadingSpinner().appendTo(this.avatarContainer);
