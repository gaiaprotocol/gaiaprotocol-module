...
export default class PersonaForm extends DomNode {
    ...
    constructor(walletAddress, existingPersona) {
        ...
        }), el(".select-name-buttons", this.ensNameButton = new Button(`.ens-name${this.personaData?.is_ens_name ? ".selected" : ""}`, {
            type: ButtonType.Outlined,
            title: "Use ENS Name",
            onClick: () => this.personaData?.is_ens_name
                ? undefined
                : new ENSNameSelectorModal((name) => this.selectENSName(name)),
        }), this.basenameButton = new Button(`.basename${this.personaData?.is_basename ? ".selected" : ""}`, {
            type: ButtonType.Outlined,
            title: "Use Basename",
            onClick: () => this.personaData?.is_basename
                ? undefined
                : new BasenameSelectorModal((name) => this.selectBasename(name)),
        }), this.gaiaNameButton = new Button(`.gaia-name${this.personaData?.is_gaia_name ? ".selected" : ""}`, {
            type: ButtonType.Outlined,
            title: "Use Gaia Name",
            onClick: () => this.personaData?.is_gaia_name
                ? undefined
