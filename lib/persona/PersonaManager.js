...
class PersonaManager {
    ...
    async savePersona(persona) {
        ...
        await GaiaProtocolConfig.supabaseConnector.callEdgeFunction("save-persona", persona);
        UserManager.setUser(await SocialCompConfig.fetchUser(persona.wallet_address));
    }
}
